...
output_dir <- paste0("/home/rstudio/workspace/results_dir/", experiment_name,"/") #  #  
...
key_metadata <- metadata %>%
  dplyr::select(experiment, cell_line, condition, timepoint_cell_harvesting, day_cell_harvesting, cell_line_label, technical_replicate) 
